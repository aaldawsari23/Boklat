...
\textbf{النتائج [6]:}
\begin{itemize}[nosep]
\item \textbf{أقل من 12 ثانية:} ماشاء الله، قوة ممتازة!
\item \textbf{12-15 ثانية:} جيد، لكن نقدر نحسّن
\item \textbf{أكثر من 15 ثانية:} ضعف واضح - تحتاجون استشارة وتمارين تقوية
\end{itemize}
...
المشي الطبيعي له مواصفات معينة [7]:
\begin{itemize}[nosep]
\item طول الخطوة متساوٍ بين القدمين
\item المسافة بين القدمين (عرض القاعدة) 5-10 سم
\item سرعة معتدلة ومنتظمة
\item الذراعين تتأرجح بشكل طبيعي مع الخطوات
\item النظر للأمام، مش للأرض طول الوقت
\end{itemize}
...
\textbf{النتائج [14]:}
\begin{itemize}[nosep]
\item \textbf{10 ثوانٍ أو أكثر:} ممتاز!
\item \textbf{5-10 ثوانٍ:} متوسط
\item \textbf{أقل من 5 ثوانٍ:} خطر سقوط مرتفع - محتاج تدخل
\end{itemize}

\textbf{لا تجرِ هذا الاختبار إذا:}
\begin{itemize}[nosep]
\item كبيرك عنده دوار شديد
\item سقط مؤخراً
\item عنده ألم حاد
\item يستخدم مشاية أو كرسي متحرك
\end{itemize}
