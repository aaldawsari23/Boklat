...
% ═══════════════════════════════════════════════════════════════════════════
% Note: microtype has limited support for RTL and XeTeX doesn't support expansion
\usepackage[
  protrusion=true,
  expansion=false,
  tracking=false,
...
\definecolor{storyborder}{RGB}{139,69,19}         % Story/experience boxes (brown accent)
\definecolor{scenarioborder}{RGB}{30,65,100}      % Scenario boxes (rich blue)
\definecolor{warnborder}{RGB}{180,60,60}          % Warning boxes (red accent)
...
\setlength{\parskip}{6pt plus 3pt minus 2pt}    % Comfortable paragraph spacing
\setlength{\parindent}{1.5em}                    % Standard indent for Arabic text

% === Line Spacing — Professional for B5 ===
\linespread{1.18}                   % Comfortable reading spacing for Arabic text
...
\titleformat{\chapter}[display]
  ...
  {% Chapter number with decorative frame
    ...
    \textcolor{chaptercolor!25}{%
      \fontsize{48}{54}\selectfont\bfseries\arabic{chapter}%
    }%
    \\[0.5cm]%
  ...
  {% Chapter title
    \vspace{0.6cm}%
    \fontsize{18}{24}\selectfont\bfseries\textcolor{chaptercolor}%
  }
...
\titleformat{\section}
  ...
  {0pt}
  {}
  [\vspace{6pt}{\textcolor{rulecolor!60}{\rule{0.15\textwidth}{0.5pt}}}]
...
% Note: Page break protection for sections is handled by titlesec package
% The needspace package with chapter/section spacing settings provides sufficient protection
% Redefining \section and \subsection can interfere with TOC generation
...
% Elegant header rule
\renewcommand{\headrule}{\vspace{-2pt}\textcolor{rulecolor!50}{\rule{\textwidth}{0.4pt}}}

% Page Numbers with decorative elements on Outer Edges
\fancyhead[RE,LO]{\textcolor{chaptercolor}{\normalsize\bfseries— \thepage{} —}}

% Chapter/Section Info on Inner Edges with elegant styling
\fancyhead[LE]{\normalsize\textcolor{chaptercolor}{\nouppercase{\leftmark}}}
